...
class MainActivity : AppCompatActivity() {
    ...
    /*
     * Handles the Android 13+ runtime notification
     * permission request.
     */
    ...
    // Events grouped by day for the currently visible month.
    private var eventsByDay:
            Map<Int, List<Event>> = emptyMap()
    ...
    override fun onCreate(
        ...
        /*
         * Existing team database/ViewModel code.
         */
        val database =
        ...
        headerMonth =
            findViewById(R.id.header_month)

        rvCalendar =
            findViewById(R.id.rv_calendar)
    ...
    override fun onResume() {
        ...
        /*
         * Reload the Room events whenever the user
    ...
    private fun showMonthYearPickerDialog() {
        ...
        val monthPicker =
            dialogView.findViewById<NumberPicker>(
                R.id.month_picker
            )
